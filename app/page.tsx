...
export default function Home() {
  return (
    <main className="min-h-screen">
      {/* ヘッダー */}
      <header className="fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-md z-50 py-2">
        <div className="container mx-auto px-6 py-6 flex justify-between items-center">
          <div className="text-2xl font-bold">Instansys</div>
          <nav>
      ...
      <section className="pt-40 pb-20 bg-gradient-to-br from-blue-50 to-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-8 whitespace-pre leading-8">
          ...
          <div className="flex justify-center">
            <a
              href="#contact"
              className="bg-emerald-500 text-white px-8 py-3 rounded-full hover:bg-green-700 transition-colors"
            >
              お問い合わせ
            </a>
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-gray-600 mb-4">合同会社Instansys</p>
                <h3 className="font-bold mb-2">設立日</h3>
                <p className="text-gray-600 mb-4">2024年11月13日</p>
                <h3 className="font-bold mb-2">代表者</h3>
                <p className="text-gray-600 mb-4">松尾 弥玖人</p>
                <h3 className="font-bold mb-2">役員</h3>
              ...
              <div>
                ...
                <p className="text-gray-600 mb-4">1,000,000円</p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">代表者略歴</h2>
          <div className="max-w-5xl mx-auto">
            <div className="space-y-8">
              <div className="flex flex-col md:flex-row gap-8 items-start">
                <div className="md:w-2/3">
                  <h3 className="text-xl font-bold mb-4">松尾 弥玖人</h3>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <h3 className="text-xl font-bold mb-3">ITコンサルティング</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mb-4">
                <MdOutlineAutoMode size={24} />
              </div>
              <h3 className="text-xl font-bold mb-3">DX支援</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <h3 className="text-xl font-bold mb-3">CV・ナレーション</h3>
              <p className="text-gray-600">
